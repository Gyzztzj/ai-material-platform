        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            ...
            return (
              <div
                key={index}
                className="bg-white border border-gray-200 rounded-xl p-6 text-center card-hover"
              >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {[
            ...
            return (
              <div
                key={index}
                className="bg-gradient-to-br from-blue-50 to-purple-50 border border-blue-100 rounded-xl p-8 card-hover"
              >
                <div className="w-14 h-14 bg-white border border-gray-200 rounded-xl flex items-center justify-center mb-6 shadow-sm">
                  <Icon className="w-7 h-7 text-blue-600" />
                </div>
                <h3 className="font-bold text-xl mb-3">{highlight.title}</h3>
