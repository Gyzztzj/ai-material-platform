              ...
              <div className="relative aspect-square">
                ...
                <div className="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition-opacity duration-200 flex items-center justify-center gap-2">
                  <button
                    ...
                    className="flex items-center justify-center w-10 h-10 bg-white/90 hover:bg-white text-gray-700 rounded-lg transition-colors"
                  >
                  ...
                  <button
                    ...
                    className="flex items-center justify-center w-10 h-10 bg-red-500/90 hover:bg-red-500 text-white rounded-lg transition-colors disabled:opacity-50"
                  >
              ...
              <div className="flex items-center p-3 gap-4">
                ...
                <div className="flex items-center gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                  <button
                    ...
                    className="flex items-center justify-center w-8 h-8 hover:bg-gray-100 text-gray-700 rounded-md transition-colors"
                  >
                  ...
                  <button
                    onClick={() => handleDelete(material.id)}
                    disabled={deletingId === material.id}
                    className="flex items-center justify-center w-8 h-8 hover:bg-red-50 text-red-600 rounded-md transition-colors disabled:opacity-50"
                  >
                    {deletingId === material.id ? (
                      <LoadingSpinner size="sm" />
                    ) : (
